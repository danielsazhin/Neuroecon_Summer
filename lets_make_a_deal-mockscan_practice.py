...
#instructions
instruct_screen = visual.TextStim(win, text="Welcome to Let's Make a Deal!\n\nIn this task you will be making decisions involving sending money to another person.\n\nPress the blue button with your right pointer finger to continue", pos = (0,1), wrapWidth=20, height = 1.2)
instruct_screen2 = visual.TextStim(win, text = 'At the beginning of each round, you will be given between $16-32.\n\nYou will decide how much to share with your partner. On some rounds, your partner has the option to Accept or Reject your offer.\nIf they reject your offer, both you and your partner earn $0 for the round.\n\nOn other rounds, they will not have a choice and will have to accept your decision.', pos = (0,1), wrapWidth=20, height = 1.2)
...
instruct_screen4 = visual.TextStim(win, text = 'On all rounds, if you would like to select the option on the left side of the screen, press the blue button (pointer finger).\n\nIf you would like to select the option on the right side of the screen, press the yellow button (middle finger).\n\n"More" and "Less" offers will switch sides between rounds.',pos = (0,1), wrapWidth=20, height = 1.2)
...
instruct_screen6 = visual.TextStim(win, text = "Each round, the decision you will see is drawn from the real choices of people who have participated in our past studies. Your choices will be used in future studies with real people.\n\nYou will not receive feedback about whether your partner accepted or rejected your proposal.\n\nOne decision will be randomly selected at the end of the study and you will be paid based on its result.",pos = (0,1),wrapWidth=20,height=1.2)
...
sampleImage1 = os.path.join(expdir,'Images','UGProposer_sq.png')
sampleImage2 = os.path.join(expdir,'Images','DGProposer_triangle.png')
