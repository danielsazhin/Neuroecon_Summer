...
cueStimCirText = visual.TextStim(win,text = "Make an offer", pos=(0,-1.5), wrapWidth=20,height=1)
...
#instructions
instruct_screen = visual.TextStim(win, text="Welcome to Let's Make a Deal!\n\nIn this task you will be making decisions sharing money with people.\n", pos = (0,1), wrapWidth=20, height = 1.2)
instruct_screen2 = visual.TextStim(win, text = 'On each round, you will be given $16-32.\n', pos = (0,1), wrapWidth=20, height = 1.2)
...
instruct_screen3 = visual.TextStim(win, text = 'You will decide how much money you would like to share with another person.\n',pos = (0,1), wrapWidth=20, height = 1.2)
instruct_screen4 = visual.TextStim(win, text = 'The partners in this game faculty members and students.\n\nSome you have met, others are random faculty members or students at Penn University', pos = (0,1), wrapWidth=20, height = 1.2)
instruct_screen5 = visual.TextStim(win, text = 'Each round, if you would like to select the option on the left side of the screen,\npress the blue button (pointer finger).\n\nIf you would like to select the option on the right side of the screen,\npress the yellow button (middle finger).\n\nOffers will sometimes switch sides between rounds.',pos = (0,1), wrapWidth=20, height = 1.2)
...
def do_run(run, trials):
    ...
    for trial in trials:
        ...
        # 1: students camp = , 2 = faculty non-camp, 3 = students camp 4 = students non-camp
        if trial['Block'] == '1':         #UG Social Condition
            counter = counter + 1
            print(counter)
            ...
            while timer.getTime() < decision_dur:
                ...
                if len(resp)>0:
                    ...
                    # 1: students camp = , 2 = faculty camp, 3 = students camp 4 = students non-camp
        if trial['Block'] == '2':         #UG Social Condition
            counter = counter + 1
            print(counter)
            while timer.getTime() < 0.5:
